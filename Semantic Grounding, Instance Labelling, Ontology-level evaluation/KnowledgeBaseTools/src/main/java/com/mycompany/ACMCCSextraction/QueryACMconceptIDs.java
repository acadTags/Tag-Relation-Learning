 ...
 * @author cleme
 */
public class QueryACMconceptIDs {
    static public final String NL = System.getProperty("line.separator") ; 
    
    public static void main(String [] args){
        
        File fileW = new File("acm_data_concept_ids.txt");
...
//            ResultSetFormatter.out(rewindable) ;
            ...
            try{
                ...
                for ( ; rs.hasNext() ; )
                {
                    ...
                    String concept = rb.get("concept").toString();
                    concept = concept.substring(concept.indexOf("#"));
                    
                    String preflabel = rb.get("preflabel").toString();
                    preflabel = preflabel.substring(0, preflabel.length()-3).trim();
                            
                    writer.write(concept + " : " + preflabel);
                    writer.newLine();
                }
                writer.flush();
                writer.close();

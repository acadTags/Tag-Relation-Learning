...
/** map taglist to the whole dbpedia skos relation. adaptable to all KBs.
 * only consider case-insensitive exact matching.
 * @author cleme
 */
public class MapTags2Dbpedia {
    public static void main(String [] args){
        int edited_dist = 0;
        String path1 = "D:\\OneDrive\\NetBeansProjects\\mallet-2.0.8";
        String path2 = "D:\\OneDrive\\NetBeansProjects\\DBpediaHierarchyExtraction";
        
        //File filetag = new File(path1 + "\\" + "citeulike-taglist-final-f5-s8.csv");
        File filetag = new File(path1 + "\\" + "bibsonomy-taglist-final-f1.csv");
        //File fileconcept = new File(path2 + "\\" + "distinct_dbpedia_skos_concept.txt");
        //File fileconcept = new File(path2 + "\\" + "distinct_dbpedia_skos_concept_with_redir.txt");
        //File fileconcept = new File(path2 + "\\" + "distinct_dbpedia_skos_concept_CS_IS.txt");
        //File fileconcept = new File(path2 + "\\" + "distinct_dbpedia_skos_concept_edu_new.txt");
        File fileconcept = new File(path2 + "\\" + "distinct_dbpedia_skos_concept_eco_disjoint_all.txt");
        //File fileW = new File(path2 + "\\" + "citeulike-tag-skos-concpet-ed" + edited_dist + ".txt");
        //File fileW = new File(path2 + "\\" + "bibsonomy-tag-skos-concept-ed" + edited_dist + "-CS_IS.txt");
        //File fileW = new File(path2 + "\\" + "bibsonomy-tag-skos-concept-ed" + edited_dist + "-edu-disjoint.txt");
        File fileW = new File(path2 + "\\" + "bibsonomy-tag-skos-concept-ed" + edited_dist + "-eco-disjoint-all.txt");

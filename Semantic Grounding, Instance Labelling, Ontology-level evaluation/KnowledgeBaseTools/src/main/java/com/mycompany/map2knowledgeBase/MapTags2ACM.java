...
public class MapTags2ACM {
    public static void main(String [] args){
        ...
        File fileconcept = new File(path2 + "\\" + "distinct_acm_concept.txt"); 
        File fileW = new File(path2 + "\\" + "bibsonomy-tag-acm-concpet-ed" + edited_dist + ".txt");

function [ nextLevelRelations,nextLevelRelations_score,candidate_tag_list ] = predictNextLevelRelationsRevForEnrichment_ft_select(model,currentLevelRelations,candidate_tag_list,taglist,pzt,ptz,pz,minF,maxF,threshold,sim_threshold,p_sig_topics,prob_estimate,feature_selection_set)
...
% set_prob_asso_3 = zeros(1,14);
% set_prob_asso_3(9:14) = 1;
% 

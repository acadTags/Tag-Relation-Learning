function [ nextLevelRelations,nextLevelRelations_score,candidate_tag_list ] = predictNextLevelRelationsRevForEnrichment(model,currentLevelRelations,candidate_tag_list,taglist,pzt,ptz,pz,minF,maxF,threshold,sim_threshold,p_sig_topics,prob_estimate,confidence_threshold_prior)
...
prediction = and(prediction,score>confidence_threshold_prior);

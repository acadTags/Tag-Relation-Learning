...
load('bibsonomy_hier_instances_final_0.001_features_14ft_ori+alex8ft.mat'); clear cell;
...
for ith_tag = 1:num_seeds
    ...
    while (size(candidate_tag_list,1)>=num_stop)
        ...
        [ next_level_relations,next_level_relations_score,candidate_tag_list ] = predictNextLevelRelationsRevForEnrichment_14ft_8ft_ada(model,current_level_relations,candidate_tag_list,taglist,pzt,ptz,pz,minF,maxF,threshold,sim_threshold,p_sig_topics,hm_taglist,co_occ_mat,co_occ_res_mat,freq_count_per_tag,res_count_per_tag,hm_nodelist,d_graph);

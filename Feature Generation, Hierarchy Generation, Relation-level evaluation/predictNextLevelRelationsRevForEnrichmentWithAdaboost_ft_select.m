function [ nextLevelRelations,nextLevelRelations_score,candidate_tag_list ] = predictNextLevelRelationsRevForEnrichmentWithAdaboost_ft_select(model,currentLevelRelations,candidate_tag_list,taglist,pzt,ptz,pz,minF,maxF,threshold,sim_threshold,p_sig_topics,feature_selection_set)
...
[prediction,score] = predict(model,feature_matrix_prediction(:,feature_selection_set));

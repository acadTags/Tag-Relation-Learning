...
for ith_tag = 1:num_seeds
    ...
    while (size(candidate_tag_list,1)>=num_stop)
        ...
        [ next_level_relations,next_level_relations_score,candidate_tag_list ] = predictNextLevelRelations_alex15_forEnrichment_adaboost(model,current_level_relations,candidate_tag_list,taglist,pzt,ptz,pz,hm_taglist,co_occ_mat,co_occ_res_mat,freq_count_per_tag,res_count_per_tag,hm_nodelist,d_graph,minF,maxF,threshold);

function eva_value = do_binary_cross_validation(y, x, param, nr_fold)
% the output eva_value is [recall,precision,f-score,accuracy,roc_auc].
len = length(y);
...
eva_value = validation_function(dec_values, labels);

function [ nextLevelRelations,nextLevelRelations_score,candidate_tag_list ] = predictNextLevelRelationsRevForEnrichmentWithAdaboost(model,currentLevelRelations,candidate_tag_list,taglist,pzt,ptz,pz,minF,maxF,threshold,p_sig_topics)

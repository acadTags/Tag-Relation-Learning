function [ nextLevelRelations,nextLevelRelations_score,candidate_tag_list ] = predictNextLevelRelations_alex15_forEnrichment_adaboost(model,currentLevelRelations,candidate_tag_list,taglist,pzt,ptz,pz,hm_taglist,co_occ_mat,co_occ_res_mat,freq_count_per_tag,res_count_per_tag,hm_nodelist,d_graph,minF,maxF,threshold)

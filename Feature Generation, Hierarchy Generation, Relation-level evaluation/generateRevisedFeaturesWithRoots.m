function feature_matrix = generateRevisedFeaturesWithRoots(tag_pair_root_cell_array,pzt,ptz,pz,taglist,p_sig_topics)
    ...
    fuzzy_set_inc1 = zeros(m,1);
    fuzzy_set_inc2 = zeros(m,2);
...
%         % get max entry difference
        ...
        % get fuzzy set inclusion
        fuzzy_set_inc1(i) = fuzzySetInclusion(vtag1,vtag2);
        fuzzy_set_inc2(i) = fuzzySetInclusion(vtag2,vtag1);
    ...
    % final 20ft
    feature_matrix = [cossim,kl_p_q,kl_q_p,gen_jaccard,max_entry_diff,aver_sig_diff,num_sig_diff,entropy_a,entropy_b,fuzzy_set_inc1,fuzzy_set_inc2,overlapped,num_rate_sig_overlapped_a,num_rate_sig_overlapped_b,pw1w2,pw2w1,pw1w2joint,pw1w2R,pw2w1R,pw1w2jointR];
end